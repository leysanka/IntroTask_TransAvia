...
public class SearchFlightsTests extends BaseTestBeforeClass {
    ...
    @Test(priority = 1, groups = {"found_flights"}, description = "Verify that correct number of date spinners shown, for one-way Outbound flight there must be 7 (one week).")
